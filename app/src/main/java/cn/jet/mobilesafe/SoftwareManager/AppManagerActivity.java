package cn.jet.mobilesafe.SoftwareManager;
...
import cn.jet.mobilesafe.SoftwareManager.adapter.AppManagerAdapter;
import cn.jet.mobilesafe.SoftwareManager.entity.AppInfo;
import cn.jet.mobilesafe.SoftwareManager.utils.AppInfoParser;

public class AppManagerActivity extends Activity implements OnClickListener{
	private static final int MSG_REFRESH_LISTVIEW = 10;
	private static final int MSG_LISTVIEW_DATA_CHANGED = 15;
	/**手机剩余内存TextView*/
	...
	private Handler mHandler = new Handler(){
		...
		public void handleMessage(android.os.Message msg) {
			...
			case MSG_REFRESH_LISTVIEW:
				...
				break;
			case MSG_LISTVIEW_DATA_CHANGED:
				adapter.notifyDataSetChanged();
				break;
			}
		};
					...
					new Thread(){
						public void run() {
							...
							if(mappInfo != null){
								...
								mHandler.sendEmptyMessage(MSG_LISTVIEW_DATA_CHANGED);
							}
						};
					}.start();
