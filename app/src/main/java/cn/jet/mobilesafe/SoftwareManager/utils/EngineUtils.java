package cn.jet.mobilesafe.SoftwareManager.utils;
...
public class EngineUtils {
	...
	public static  void uninstallApplication(Context context,AppInfo appInfo) {
		if (appInfo.isUserApp) {
			...
			try {
				//ToDo: RootTools.isAccessGiven() 引发java.util.concurrent.TimeoutException
				if(!RootTools.isAccessGiven()){
					Toast.makeText(context, "请授权手机小护卫root权限", 0).show();
					return ;
				}
