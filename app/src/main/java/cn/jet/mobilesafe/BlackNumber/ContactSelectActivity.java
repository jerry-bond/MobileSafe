...
import cn.jet.mobilesafe.BlackNumber.adapter.ContactAdapter;
import cn.jet.mobilesafe.BlackNumber.entity.ContactInfo;
import cn.jet.mobilesafe.BlackNumber.utils.ContactInfoParser;

public class ContactSelectActivity extends Activity implements OnClickListener {

	private final static int MSG_CONTACT_PARSED_DONE = 10;
	...
	private void initView() {
		...
		new Thread(){
			public void run() {
				...
				mHandler.sendEmptyMessage(MSG_CONTACT_PARSED_DONE);
			};
		}.start();
