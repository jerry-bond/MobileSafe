package cn.jet.mobilesafe.BlackNumber.db.DBOperator;
...
import cn.jet.mobilesafe.BlackNumber.db.BlackNumberOpenHelper;
import cn.jet.mobilesafe.BlackNumber.entity.BlackContactInfo;

public class BlackNumberDBOperator {

	private BlackNumberOpenHelper blackNumberOpenHelper;

	public BlackNumberDBOperator(Context context) {
		super();
	...
	public List<BlackContactInfo> getPageBlackNumber(int pagenumber,
		...
		while (cursor.moveToNext()) {
			...
			info.phoneNumber = cursor.getString(cursor.getColumnIndex("number"));
			info.mode = cursor.getInt(cursor.getColumnIndex("mode"));
			info.contactName = cursor.getString(cursor.getColumnIndex("name"));
