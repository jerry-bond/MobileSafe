...
import cn.jet.mobilesafe.ProcessManagement.service.AutoKillProcessService;
...
public class ProcessManagerSettingActivity extends Activity implements OnClickListener, OnCheckedChangeListener{
	...
	private void initView() {
		...
		mIsServiceRunning = SystemInfoUtils.isServiceRunning(this, "cn.jet.mobilesafe.ProcessManagement.service.AutoKillProcessService");
		mKillProcessTgb.setChecked(mIsServiceRunning);
		initListener();
	}
